...
// CORS configuration (allow requests from client app, Vercel deployments, and localhost)
const allowedOrigins = [
  'https://e-learning-8kov.vercel.app',
  'https://vishakhamam-elearning-web.onrender.com',
  'http://localhost:5173',
  'http://localhost:3000',
  'http://localhost:5000',
